...
def get_test_results(label_path, txt_filename):
    ...
    with open(f'{txt_filename}.txt', 'w') as f:
...
if __name__ == '__main__' :
    ...
    path = '/Users/lfin/Downloads/back_youtube.v3.helmet-noface--vest-shoe.yolov5pytorch/train/labels'
    txt_filename = '/Users/lfin/Downloads/back_youtube.v3.helmet-noface--vest-shoe.yolov5pytorch/train/obj_count'
